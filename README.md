...
- SHE_SEAL_Client: A complete client implementation using SEAL and an interactive terminal. Does not take timings and returns incorrect results, since SEAL modifications break the calculations at some point.
